...
public void updateAutoTransfer(Long userId, AllowanceUpdateAutoTransferReq req, Long autoTransferId) {
     ...
     */
    @Override
    public Page<AutoTransfer> getAllAutoTransfers(
            Pageable pageable
    ) {
     ...
     */
    @Override
    public Page<AutoTransfer> getAutoTransfersByStatus(
     ...
     */
    @Override
    public Page<AutoTransfer> getAutoTransfersByDateRange(
            LocalDate startDate,
            LocalDate endDate,
            Pageable pageable
    ) {
     ...
     */
    @Override
    public org.springframework.data.domain.Page<AutoTransfer> getAutoTransfersByStatusAndDateRange(
            AutoTransferStatus status,
            LocalDate startDate,
            LocalDate endDate,
            org.springframework.data.domain.Pageable pageable
    ) {
        return autoTransferRepository.findByStatusAndNextTransferDayBetween(
    ...
    public void executeAutoTransferManually(Long autoTransferId) {
        ...
        log.info("[관리자 수동 실행] 자동이체 ID: {}, 금액: {}", autoTransferId, autoTransfer.getAmount());
        execute(autoTransfer);
    }
